...
WebUI.click(findTestObject('Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Recurring input_Amount_transactionScheduleType'))

WebUI.click(findTestObject('Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Drop down Select Frequency Recurring'))

WebUI.click(findTestObject('Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Select Daily Frequency'))

WebUI.setText(findTestObject('Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/input start Period'), '02/03/2023')

WebUI.delay(2)

WebUI.setText(findTestObject('Maker Role/Page_BRICaMS Cash  Trade/textarea_Remark_remark'), 'Testing Automate')

WebUI.click(findTestObject('Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Dropdown Select Recurring Time'))

WebUI.click(findTestObject('Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/Select Recurring Time'))

WebUI.setText(findTestObject('Maker Role/Transaction Schedule/Page_BRICaMS Cash  Trade/input end Period'), '03/03/2023')
