...
WebUI.click(findTestObject('Checker Role/Page_BRICaMS Cash  Trade/span_Send for Rework'))
...
WebUI.click(findTestObject('Signer Role/Pop up Not Approve/span_Send Task for Rework'))
