...
WebUI.click(findTestObject('Object Repository/Page_BRICaMS Cash  Trade/Master/Company Management/Create Group/Reject/input_Username_focusring-1 hoverring-primar_45f28b'))
...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Create Group/Rework/Page_BRICaMS Cash  Trade/button_Send for Rework 1'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Create Group/Rework/Page_BRICaMS Cash  Trade/input_Reasons for rework'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Create Group/Rework/Page_BRICaMS Cash  Trade/button_Send for rework 2'))
