...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Delete/Page_BRICaMS Cash  Trade/button_Approve'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Delete/Page_BRICaMS Cash  Trade/Page_BRICaMS Cash  Trade/button_Yes, Delete 2'))
