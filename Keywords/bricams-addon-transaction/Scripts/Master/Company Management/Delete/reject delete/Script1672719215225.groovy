...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Delete/Page_BRICaMS Cash  Trade/a_SEHAT SELALU'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Delete/Page_BRICaMS Cash  Trade/button_Reject 1'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Delete/Page_BRICaMS Cash  Trade/input_Reasons for rejection'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Company Management/Delete/Page_BRICaMS Cash  Trade/button_Reject 2'))
