...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Announcement Management/aPPROVAL/Page_BRICaMS Cash  Trade/button_SendforRework 1'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Announcement Management/aPPROVAL/Page_BRICaMS Cash  Trade/input_Reasons for rework_checkboxRework'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Announcement Management/aPPROVAL/Page_BRICaMS Cash  Trade/button_Send For Rework 2'))
