...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Announcement Management/aPPROVAL/Page_BRICaMS Cash  Trade/button_Reject 1'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Announcement Management/aPPROVAL/Page_BRICaMS Cash  Trade/input_Reasons for rejection_RJT'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Master/Announcement Management/aPPROVAL/Page_BRICaMS Cash  Trade/button_Reject 2'))
