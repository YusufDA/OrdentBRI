...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/System Mangement/a_min-online-transfer-transaction'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/System Mangement/span_Reject'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/System Mangement/input_Reasons for rejection_rounded text-primary-60'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/System Mangement/button_Reject'))
