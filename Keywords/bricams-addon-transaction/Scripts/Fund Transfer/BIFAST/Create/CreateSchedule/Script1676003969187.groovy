...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/Create/input_Transfer Amount_Schedule'), FailureHandling.STOP_ON_FAILURE)

def tomorrow = LocalDate.now().plusDays(1)

def tomorrowString = tomorrow.format(DateTimeFormatter.ofPattern('MM-dd-yyyy'))

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/Create/input_Pick Date'), tomorrowString + Keys.ENTER)

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/Create/ScheduleTime'), '07:00' + Keys.ENTER)
