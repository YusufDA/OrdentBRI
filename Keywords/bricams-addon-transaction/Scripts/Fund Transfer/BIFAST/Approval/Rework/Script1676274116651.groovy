...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Page_BRICaMS Cash  Trade/button_On Signer Rework'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Page_BRICaMS Cash  Trade/input_Reason for Rework'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Page_BRICaMS Cash  Trade/button_Send Task for Rework'))
