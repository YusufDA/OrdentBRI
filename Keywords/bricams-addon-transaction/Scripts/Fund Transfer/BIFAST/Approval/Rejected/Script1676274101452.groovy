...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Page_BRICaMS Cash  Trade/button_On Signe Reject'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Page_BRICaMS Cash  Trade/input_Reason for Rejection'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/BIFAST/History/Page_BRICaMS Cash  Trade/button_Reject Task'))
