...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Approval/Page_BRICaMS Cash  Trade/button_On Checker Approve'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Approval/Page_BRICaMS Cash  Trade/button_Approve Task'))
