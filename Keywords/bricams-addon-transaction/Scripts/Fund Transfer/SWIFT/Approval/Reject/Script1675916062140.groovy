...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Approval/Page_BRICaMS Cash  Trade/button_On Checker Reject'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Approval/Page_BRICaMS Cash  Trade/input_Reason for Rejection'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Approval/Page_BRICaMS Cash  Trade/button_Reject Task'))
