...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Login/Page_BRICaMS Cash  Trade/input_Username'), 'CU_TESLAINC_S')

WebUI.setEncryptedText(findTestObject('Page_BRICaMS Cash  Trade/Login/Page_BRICaMS Cash  Trade/input_Password'), 'uBK22oCU349fsKMqxRooBg==')
...
WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Page_BRICaMS Cash  Trade/button_Reject 1'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Page_BRICaMS Cash  Trade/input_Reasons for rejection_'))

WebUI.click(findTestObject('Page_BRICaMS Cash  Trade/Fund Transfer/SWIFT/Page_BRICaMS Cash  Trade/button_Reject 2'))
