...
WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Digi Guarantee/BG Issuing/Create/Page3/No Rek Non Cash'), NoRek2 + 
    Keys.ENTER)

WebUI.setText(findTestObject('Page_BRICaMS Cash  Trade/Digi Guarantee/BG Issuing/Create/Page3/Nominal Non Cash'), NomCash)
